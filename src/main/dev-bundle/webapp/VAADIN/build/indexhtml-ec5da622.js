 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var to,oo,ro,io;const U=window,v=t=>{U.emitLitDebugLogEvents&&U.dispatchEvent(new CustomEvent("lit-debug",{detail:t}))};let Nn=0,Tt;(to=U.litIssuedWarnings)!==null&&to!==void 0||(U.litIssuedWarnings=new Set),Tt=(t,e)=>{e+=t?` See https://lit.dev/msg/${t} for more information.`:"",U.litIssuedWarnings.has(e)||(console.warn(e),U.litIssuedWarnings.add(e))},Tt("dev-mode","Lit is in dev mode. Not recommended for production!");const H=!((oo=U.ShadyDOM)===null||oo===void 0)&&oo.inUse&&((ro=U.ShadyDOM)===null||ro===void 0?void 0:ro.noPatch)===!0?U.ShadyDOM.wrap:t=>t,Le=U.trustedTypes,Sr=Le?Le.createPolicy("lit-html",{createHTML:t=>t}):void 0,Pn=t=>t,Dt=(t,e,o)=>Pn,An=t=>{if(_e!==Dt)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");_e=t},In=()=>{_e=Dt},$o=(t,e,o)=>_e(t,e,o),To="$lit$",re=`lit$${String(Math.random()).slice(9)}$`,gi="?"+re,Rn=`<${gi}>`,xe=document,Ye=()=>xe.createComment(""),Je=t=>t===null||typeof t!="object"&&typeof t!="function",fi=Array.isArray,On=t=>fi(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",no=`[ 	
\f\r]`,zn=`[^ 	
\f\r"'\`<>=]`,Ln=`[^\\s"'>=/]`,Fe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Er=1,so=2,Mn=3,Cr=/-->/g,kr=/>/g,fe=new RegExp(`>|${no}(?:(${Ln}+)(${no}*=${no}*(?:${zn}|("|')|))|$)`,"g"),Vn=0,$r=1,Dn=2,Tr=3,ao=/'/g,lo=/"/g,vi=/^(?:script|style|textarea|title)$/i,Un=1,Nt=2,Lo=1,Pt=2,jn=3,Fn=4,Bn=5,Mo=6,Hn=7,yi=t=>(e,...o)=>(e.some(r=>r===void 0)&&console.warn(`Some template strings are undefined.
This is probably caused by illegal octal escape sequences.`),{_$litType$:t,strings:e,values:o}),f=yi(Un),Pe=yi(Nt),we=Symbol.for("lit-noChange"),k=Symbol.for("lit-nothing"),Nr=new WeakMap,ye=xe.createTreeWalker(xe,129,null,!1);let _e=Dt;const Wn=(t,e)=>{const o=t.length-1,r=[];let i=e===Nt?"<svg>":"",n,s=Fe;for(let a=0;a<o;a++){const d=t[a];let c=-1,m,h=0,g;for(;h<d.length&&(s.lastIndex=h,g=s.exec(d),g!==null);)if(h=s.lastIndex,s===Fe){if(g[Er]==="!--")s=Cr;else if(g[Er]!==void 0)s=kr;else if(g[so]!==void 0)vi.test(g[so])&&(n=new RegExp(`</${g[so]}`,"g")),s=fe;else if(g[Mn]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else s===fe?g[Vn]===">"?(s=n??Fe,c=-1):g[$r]===void 0?c=-2:(c=s.lastIndex-g[Dn].length,m=g[$r],s=g[Tr]===void 0?fe:g[Tr]==='"'?lo:ao):s===lo||s===ao?s=fe:s===Cr||s===kr?s=Fe:(s=fe,n=void 0);console.assert(c===-1||s===fe||s===ao||s===lo,"unexpected parse state B");const ne=s===fe&&t[a+1].startsWith("/>")?" ":"";i+=s===Fe?d+Rn:c>=0?(r.push(m),d.slice(0,c)+To+d.slice(c)+re+ne):d+re+(c===-2?(r.push(void 0),a):ne)}const l=i+(t[o]||"<?>")+(e===Nt?"</svg>":"");if(!Array.isArray(t)||!t.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
 ...
 */const bi=Symbol.for(""),us=t=>{if((t==null?void 0:t.r)===bi)return t==null?void 0:t._$litStatic$},ps=t=>{if(t._$litStatic$!==void 0)return t._$litStatic$;throw new Error(`Value passed to 'literal' function must be a 'literal' result: ${t}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)},mt=(t,...e)=>({_$litStatic$:e.reduce((o,r,i)=>o+ps(r)+t[i+1],t[0]),r:bi}),Ar=new Map,ms=t=>(e,...o)=>{const r=o.length;let i,n;const s=[],l=[];let a=0,d=!1,c;for(;a<r;){for(c=e[a];a<r&&(n=o[a],(i=us(n))!==void 0);)c+=i+e[++a],d=!0;a!==r&&l.push(n),s.push(c),a++}if(a===r&&s.push(e[r]),d){const m=s.join("$$lit$$");e=Ar.get(m),e===void 0&&(s.raw=s,Ar.set(m,e=s)),o=l}return t(e,...o)},gs=ms(f),fs="modulepreload",vs=function(t){return"/"+t},Ir={},S=function(t,e,o){if(!e||e.length===0)return t();const r=document.getElementsByTagName("link");return Promise.all(e.map(i=>{if(i=vs(i),i in Ir)return;Ir[i]=!0;const n=i.endsWith(".css"),s=n?'[rel="stylesheet"]':"";if(o)for(let a=r.length-1;a>=0;a--){const d=r[a];if(d.href===i&&(!n||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${s}`))return;const l=document.createElement("link");if(l.rel=n?"stylesheet":fs,n||(l.as="script",l.crossOrigin=""),l.href=i,document.head.appendChild(l),n)return new Promise((a,d)=>{l.addEventListener("load",a),l.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>t())};function ys(t){var e;const o=[];for(;t&&t.parentNode;){const r=bs(t);if(r.nodeId!==-1){if((e=r.element)!=null&&e.tagName.startsWith("FLOW-CONTAINER-"))break;o.push(r)}t=t.parentElement?t.parentElement:t.parentNode.host}return o.reverse()}function bs(t){const e=window.Vaadin;if(e&&e.Flow){const{clients:o}=e.Flow,r=Object.keys(o);for(const i of r){const n=o[i];if(n.getNodeId){const s=n.getNodeId(t);if(s>=0)return{nodeId:s,uiId:n.getUIId(),element:t}}}}return{nodeId:-1,uiId:-1,element:void 0}}function xs(t,e){if(t.contains(e))return!0;let o=e;const r=e.ownerDocument;for(;o&&o!==r&&o!==t;)o=o.parentNode||(o instanceof ShadowRoot?o.host:null);return o===t}const ws=(t,e)=>{const o=t[e];return o?typeof o=="function"?o():Promise.resolve(o):new Promise((r,i)=>{(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(i.bind(null,new Error("Unknown variable dynamic import: "+e)))})};var P=(t=>(t.text="text",t.checkbox="checkbox",t.range="range",t.color="color",t))(P||{});const J={lumoSize:["--lumo-size-xs","--lumo-size-s","--lumo-size-m","--lumo-size-l","--lumo-size-xl"],lumoSpace:["--lumo-space-xs","--lumo-space-s","--lumo-space-m","--lumo-space-l","--lumo-space-xl"],lumoBorderRadius:["0","--lumo-border-radius-m","--lumo-border-radius-l"],lumoFontSize:["--lumo-font-size-xxs","--lumo-font-size-xs","--lumo-font-size-s","--lumo-font-size-m","--lumo-font-size-l","--lumo-font-size-xl","--lumo-font-size-xxl","--lumo-font-size-xxxl"],lumoTextColor:["--lumo-header-text-color","--lumo-body-text-color","--lumo-secondary-text-color","--lumo-tertiary-text-color","--lumo-disabled-text-color","--lumo-primary-text-color","--lumo-error-text-color","--lumo-success-text-color"],basicBorderSize:["0px","1px","2px","3px"]},_s=Object.freeze(Object.defineProperty({__proto__:null,presets:J},Symbol.toStringTag,{value:"Module"})),We={textColor:{propertyName:"color",displayName:"Text color",editorType:P.color,presets:J.lumoTextColor},fontSize:{propertyName:"font-size",displayName:"Font size",editorType:P.range,presets:J.lumoFontSize,icon:"font"},fontWeight:{propertyName:"font-weight",displayName:"Bold",editorType:P.checkbox,checkedValue:"bold"},fontStyle:{propertyName:"font-style",displayName:"Italic",editorType:P.checkbox,checkedValue:"italic"}},Ae={backgroundColor:{propertyName:"background-color",displayName:"Background color",editorType:P.color},borderColor:{propertyName:"border-color",displayName:"Border color",editorType:P.color},borderWidth:{propertyName:"border-width",displayName:"Border width",editorType:P.range,presets:J.basicBorderSize,icon:"square"},borderRadius:{propertyName:"border-radius",displayName:"Border radius",editorType:P.range,presets:J.lumoBorderRadius,icon:"square"},padding:{propertyName:"padding",displayName:"Padding",editorType:P.range,presets:J.lumoSpace,icon:"square"},gap:{propertyName:"gap",displayName:"Spacing",editorType:P.range,presets:J.lumoSpace,icon:"square"}},Ss={height:{propertyName:"height",displayName:"Size",editorType:P.range,presets:J.lumoSize,icon:"square"},paddingInline:{propertyName:"padding-inline",displayName:"Padding",editorType:P.range,presets:J.lumoSpace,icon:"square"}},Es={iconColor:{propertyName:"color",displayName:"Icon color",editorType:P.color,presets:J.lumoTextColor},iconSize:{propertyName:"font-size",displayName:"Icon size",editorType:P.range,presets:J.lumoFontSize,icon:"font"}},Cs=Object.freeze(Object.defineProperty({__proto__:null,fieldProperties:Ss,iconProperties:Es,shapeProperties:Ae,textProperties:We},Symbol.toStringTag,{value:"Module"}));function xi(t){const e=t.charAt(0).toUpperCase()+t.slice(1);return{tagName:t,displayName:e,elements:[{selector:t,displayName:"Element",properties:[Ae.backgroundColor,Ae.borderColor,Ae.borderWidth,Ae.borderRadius,Ae.padding,We.textColor,We.fontSize,We.fontWeight,We.fontStyle]}]}}const ks=Object.freeze(Object.defineProperty({__proto__:null,createGenericMetadata:xi},Symbol.toStringTag,{value:"Module"})),$s=t=>ws(Object.assign({"./components/defaults.ts":()=>S(()=>Promise.resolve().then(()=>Cs),void 0),"./components/generic.ts":()=>S(()=>Promise.resolve().then(()=>ks),void 0),"./components/presets.ts":()=>S(()=>Promise.resolve().then(()=>_s),void 0),"./components/vaadin-app-layout.ts":()=>S(()=>E(()=>import("./vaadin-app-layout-37492a04-8df5a0b4.js"),[],import.meta.url),[]),"./components/vaadin-avatar.ts":()=>S(()=>E(()=>import("./vaadin-avatar-7047be31-107da986.js"),[],import.meta.url),[]),"./components/vaadin-big-decimal-field.ts":()=>S(()=>E(()=>import("./vaadin-big-decimal-field-b42c1de1-889edc28.js"),["./vaadin-big-decimal-field-b42c1de1-889edc28.js","./vaadin-text-field-e82c445d-3a44d2dd.js"],import.meta.url),["assets/vaadin-big-decimal-field-b42c1de1.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-button.ts":()=>S(()=>E(()=>import("./vaadin-button-79ad9d5f-dd89d79c.js"),[],import.meta.url),[]),"./components/vaadin-checkbox-group.ts":()=>S(()=>E(()=>import("./vaadin-checkbox-group-a9a9e85d-f951de07.js"),["./vaadin-checkbox-group-a9a9e85d-f951de07.js","./vaadin-text-field-e82c445d-3a44d2dd.js","./vaadin-checkbox-13797fc9-a26b789a.js"],import.meta.url),["assets/vaadin-checkbox-group-a9a9e85d.js","assets/vaadin-text-field-e82c445d.js","assets/vaadin-checkbox-13797fc9.js"]),"./components/vaadin-checkbox.ts":()=>S(()=>E(()=>import("./vaadin-checkbox-13797fc9-a26b789a.js"),[],import.meta.url),[]),"./components/vaadin-combo-box.ts":()=>S(()=>E(()=>import("./vaadin-combo-box-9046f78f-d09ed5df.js"),["./vaadin-combo-box-9046f78f-d09ed5df.js","./vaadin-text-field-e82c445d-3a44d2dd.js"],import.meta.url),["assets/vaadin-combo-box-9046f78f.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-email-field.ts":()=>S(()=>E(()=>import("./vaadin-email-field-da851bcb-8196379c.js"),["./vaadin-email-field-da851bcb-8196379c.js","./vaadin-text-field-e82c445d-3a44d2dd.js"],import.meta.url),["assets/vaadin-email-field-da851bcb.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-horizontal-layout.ts":()=>S(()=>E(()=>import("./vaadin-horizontal-layout-f7b1ab51-f6071f36.js"),[],import.meta.url),[]),"./components/vaadin-integer-field.ts":()=>S(()=>E(()=>import("./vaadin-integer-field-6e2954cf-bf3520d8.js"),["./vaadin-integer-field-6e2954cf-bf3520d8.js","./vaadin-text-field-e82c445d-3a44d2dd.js"],import.meta.url),["assets/vaadin-integer-field-6e2954cf.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-menu-bar.ts":()=>S(()=>E(()=>import("./vaadin-menu-bar-be33385c-821b01ca.js"),[],import.meta.url),[]),"./components/vaadin-number-field.ts":()=>S(()=>E(()=>import("./vaadin-number-field-31df11f5-7c1eb86b.js"),["./vaadin-number-field-31df11f5-7c1eb86b.js","./vaadin-text-field-e82c445d-3a44d2dd.js"],import.meta.url),["assets/vaadin-number-field-31df11f5.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-password-field.ts":()=>S(()=>E(()=>import("./vaadin-password-field-49ffb113-aa703aa9.js"),["./vaadin-password-field-49ffb113-aa703aa9.js","./vaadin-text-field-e82c445d-3a44d2dd.js"],import.meta.url),["assets/vaadin-password-field-49ffb113.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-progress-bar.ts":()=>S(()=>E(()=>import("./vaadin-progress-bar-3b53bb70-01c92e93.js"),[],import.meta.url),[]),"./components/vaadin-radio-group.ts":()=>S(()=>E(()=>import("./vaadin-radio-group-4a6e2cf4-62c02e4b.js"),["./vaadin-radio-group-4a6e2cf4-62c02e4b.js","./vaadin-text-field-e82c445d-3a44d2dd.js"],import.meta.url),["assets/vaadin-radio-group-4a6e2cf4.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-scroller.ts":()=>S(()=>E(()=>import("./vaadin-scroller-35e68818-dc452932.js"),[],import.meta.url),[]),"./components/vaadin-select.ts":()=>S(()=>E(()=>import("./vaadin-select-5d6ab45b-2314527f.js"),["./vaadin-select-5d6ab45b-2314527f.js","./vaadin-text-field-e82c445d-3a44d2dd.js"],import.meta.url),["assets/vaadin-select-5d6ab45b.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-split-layout.ts":()=>S(()=>E(()=>import("./vaadin-split-layout-10c9713b-285a73c6.js"),[],import.meta.url),[]),"./components/vaadin-text-area.ts":()=>S(()=>E(()=>import("./vaadin-text-area-41c5f60c-b9889a1b.js"),["./vaadin-text-area-41c5f60c-b9889a1b.js","./vaadin-text-field-e82c445d-3a44d2dd.js"],import.meta.url),["assets/vaadin-text-area-41c5f60c.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-text-field.ts":()=>S(()=>E(()=>import("./vaadin-text-field-e82c445d-3a44d2dd.js"),[],import.meta.url),[]),"./components/vaadin-time-picker.ts":()=>S(()=>E(()=>import("./vaadin-time-picker-2fa5314f-d585f85a.js"),["./vaadin-time-picker-2fa5314f-d585f85a.js","./vaadin-text-field-e82c445d-3a44d2dd.js"],import.meta.url),["assets/vaadin-time-picker-2fa5314f.js","assets/vaadin-text-field-e82c445d.js"]),"./components/vaadin-vertical-layout.ts":()=>S(()=>E(()=>import("./vaadin-vertical-layout-ff73c403-714ff713.js"),[],import.meta.url),[]),"./components/vaadin-virtual-list.ts":()=>S(()=>E(()=>import("./vaadin-virtual-list-62d4499a-8f766e2f.js"),[],import.meta.url),[])}),`./components/${t}.ts`);class Ts{constructor(e=$s){this.loader=e,this.metadata={}}async getMetadata(e){var o;const r=(o=e.element)==null?void 0:o.localName;if(!r)return null;if(!r.startsWith("vaadin-"))return xi(r);let i=this.metadata[r];if(i)return i;try{i=(await this.loader(r)).default,this.metadata[r]=i}catch{console.warn(`Failed to load metadata for component: ${r}`)}return i||null}}const Ns=new Ts,_t={crosshair:Pe`<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
`);let tt=class extends A{constructor(){super(...arguments),this.value=D.local}static get styles(){return y`
    ...
    ></vaadin-select>`}selectRenderer(t){var e;const o=((e=this.metadata)==null?void 0:e.displayName)||"Component",r=`${o}s`;Oe(f`
      ...
      `,t)}handleValueChange(t){const e=t.detail.value;e!==this.value&&this.dispatchEvent(new Ws(e))}};Ft([b({})],tt.prototype,"value",2);Ft([b({})],tt.prototype,"metadata",2);Ft([nt("vaadin-select")],tt.prototype,"select",2);tt=Ft([F("vaadin-dev-tools-theme-scope-selector")],tt);var qs=Object.defineProperty,Gs=Object.getOwnPropertyDescriptor,Ks=(t,e,o,r)=>{for(var i=r>1?void 0:r?Gs(e,o):e,n=t.length-1,s;n>=0;n--)(s=t[n])&&(i=(r?s(e,o,i):s(i))||i);return r&&i&&qs(e,o,i),i};let Ur=class extends W{static get styles(){return[W.styles,y`
        .editor-row {
          align-items: center;
        }
      ...
      <vaadin-dev-tools-theme-text-input
        ...
        @change=${this.handleInputChange}
      ></vaadin-dev-tools-theme-text-input>
    `}};jr=Xs([F("vaadin-dev-tools-theme-text-property-editor")],jr);var Qs=Object.defineProperty,Zs=Object.getOwnPropertyDescriptor,jo=(t,e,o,r)=>{for(var i=r>1?void 0:r?Zs(e,o):e,n=t.length-1,s;n>=0;n--)(s=t[n])&&(i=(r?s(e,o,i):s(i))||i);return r&&i&&Qs(e,o,i),i};let Rt=class extends W{constructor(){super(...arguments),this.selectedPresetIndex=-1,this.presets=new At}static get styles(){return[W.styles,y`
        :host {
          --preset-count: 3;
          --slider-bg: #fff;
          --slider-border: #333;
...
`;let ot=class extends A{constructor(){super(...arguments),this.commitValue=!1}static get styles(){return[Ei,y`
        #toggle {
          display: block;
        }
    ...
    ></button>`}open(){this.commitValue=!1,this.overlay.opened=!0,this.overlay.style.zIndex="1000000";const t=this.overlay.shadowRoot.querySelector('[part="overlay"]');t.style.background="#333"}renderOverlayContent(t){const e=getComputedStyle(this.toggle,"::after").getPropertyValue("background-color");Oe(f` <div>
        ...
        ></vaadin-dev-tools-color-picker-overlay-content>
      </div>`,t)}handleColorChange(t){this.commitValue=!0,this.dispatchEvent(new Sa(t.detail.value)),t.detail.close&&(this.overlay.opened=!1,this.handleOverlayClose())}handleOverlayEscape(){this.commitValue=!1}handleOverlayClose(){const t=this.commitValue?"color-picker-commit":"color-picker-cancel";this.dispatchEvent(new CustomEvent(t))}};Se([b({})],ot.prototype,"value",2);Se([b({})],ot.prototype,"presets",2);Se([nt("#toggle")],ot.prototype,"toggle",2);ot=Se([F("vaadin-dev-tools-color-picker")],ot);let Lt=class extends A{static get styles(){return[Ei,y`
        :host {
          display: block;
          padding: 12px;
        }
      ...
      ></button>`);return f` <div class="swatches">${t}</div>`}handlePickerChange(t){this.dispatchEvent(new CustomEvent("color-changed",{detail:{value:t.detail.value}}))}selectPreset(t){this.dispatchEvent(new CustomEvent("color-changed",{detail:{value:t,close:!0}}))}};Se([b({})],Lt.prototype,"value",2);Se([b({})],Lt.prototype,"presets",2);Lt=Se([F("vaadin-dev-tools-color-picker-overlay-content")],Lt);customElements.whenDefined("vaadin-overlay").then(()=>{const t=customElements.get("vaadin-overlay");class e extends xa(t){}customElements.define("vaadin-dev-tools-color-picker-overlay",e)});customElements.define("vaadin-dev-tools-rgba-string-color-picker",ya);var Ea=Object.defineProperty,Ca=Object.getOwnPropertyDescriptor,ka=(t,e,o,r)=>{for(var i=r>1?void 0:r?Ca(e,o):e,n=t.length-1,s;n>=0;n--)(s=t[n])&&(i=(r?s(e,o,i):s(i))||i);return r&&i&&Ea(e,o,i),i};let Gr=class extends W{constructor(){super(...arguments),this.presets=new At}static get styles(){return[W.styles,y`
        .editor-row {
          align-items: center;
        }
    ...
    `];Vt=Ia([F("vaadin-dev-tools-shim")],Vt);const Ci=y`
  .popup {
    width: auto;
    position: fixed;
...
`;he("",Go,{moduleId:"lumo-typography"});ge("typography-props",gl);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const fl=y`
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */ge("utility",Jo);const Tl=t=>{const e=[];t!==document&&(e.push(He(Go.cssText,"",t,!0)),e.push(He(Ko.cssText,"",t,!0)),e.push(He(Ii.cssText,"",t,!0)),e.push(He(Yo.cssText,"",t,!0)),e.push(He(Jo.cssText,"",t,!0)))},Nl=Tl;Nl(document);export{ss as D,We as F,A as L,is as P,Il as T,Ae as U,E as _,ge as a,we as b,y as c,ns as d,he as e,Ko as f,Go as g,ol as h,f as i,J as j,Ss as k,Es as l,k as n,Oe as r,Pe as s,Ni as t,Re as u,P as y};
